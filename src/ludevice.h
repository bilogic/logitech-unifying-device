...
#define LOGITACKER_DEVICE_CAPS_BATTERY_STATUS (1 << 1)
#define LOGITACKER_DEVICE_CAPS_UNIFYING_COMPATIBLE (1 << 2)
#define LOGITACKER_DEVICE_CAPS_UNKNOWN1 (1 << 3)
...
private:
    ...
    uint8_t wakeup_keyboard1[10] = {
        0x00,        // RF prefix
        0x10 | 0x40, // 0x10 keyboard, 0x40 is device to dongle
        0x00,        // RF prefix
        0x4B,
        0x01,
        0x00, 0x00, 0x00, 0x00,
    ...
    uint8_t pairing_packet_3[22] = {
        0x00,
        0x1F | 0x40, // 0x40 is device to dongle
        0x03,        // step 3
    ...
    uint8_t keep_alive_change_packet[10] = {
        0x00,
        0x0F | 0x40,            // 0x40 is device to dongle
        0x00,                   // unused
